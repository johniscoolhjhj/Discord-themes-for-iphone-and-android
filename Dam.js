...
:root {
  --background-image: url('https://i.imgur.com/ebPhu5X.jpg'); /* Background image | URL MUST BE A DIRECT LINK (ending in .jpg, .jpeg, .png, .gif) */
  --background-blur: 0px; /* Blur intensity of --background-image */
  --opacity: 0.68; /* Opacity of overall app. | Default: .85 */
  --accent: 33,177,139; /* Colour used around the app. | Values are in R,G,B format. | Default: 0, 231, 169 */
